# -*- coding: utf-8 -*-
"""
Created on Mon Oct 30 08:47:50 2017
...
def read_data(file_num,start_frq,end_frq):
    ...
    for i in range(file_num):
        ...
        z3 = np.array([z2])
    return z3
data_egsm_up1 = read_data(850,890,900).reshape(850,401)
...
train_data = [data_egsm_up1,data_lte1]
train = train_data[0]
...
test_data = [test_egsm_up1,test_lte1]
test = test_data[0]
for i in range(len(test_data)-1):
    test = np.vstack((test,test_data[i+1]))
#######################################shuffle#######
idx=random.sample(range(850),850) 
idx1 = random.sample(range(31),31)
train = train[idx]
