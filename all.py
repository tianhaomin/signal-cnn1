...
train_data = [data_cdma_down2,data_egsm_up2,data_egsm_down1,data_wlan1]
train = train_data[0]
...
##############
test_data = [test_cdma_down1,test_egsm_up1,test_egsm_down1,test_wlan1]
