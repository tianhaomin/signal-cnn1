# -*- coding: utf-8 -*-
"""
Created on Mon Oct 30 10:50:29 2017
...
data_lte3 = read_data(850,1890,1895).reshape(850,201)
data_lte4 = read_data(850,1895,1900).reshape(850,201)
...
data_lte3 = np.array( [[row[i] for i in range(0, 201) if i != 200] for row in data_lte3] )
data_lte4 = np.array( [[row[i] for i in range(0, 201) if i != 200] for row in data_lte4] )
train_data = [data_egsm_up1,data_egsm_up2,data_egsm_up3,data_egsm_up4,data_lte1,data_lte2,data_lte3,data_lte4]
train = train_data[0]
...
test_lte3 = read_data(31,1890,1895).reshape(31,201)
test_lte4 = read_data(31,1895,1900).reshape(31,201)
...
test_lte3 = np.array( [[row[i] for i in range(0, 201) if i != 200] for row in test_lte3] )
test_lte4 = np.array( [[row[i] for i in range(0, 201) if i != 200] for row in test_lte2] )
...
test_data = [test_egsm_up1,test_egsm_up2,test_egsm_up3,test_egsm_up4,test_lte1,test_lte2,test_lte3,test_lte4]
test = test_data[0]
...
log_dir1 = 'D:/temp/tensorflow/project/logs/projectcnn_with_summaries2_1'
