# -*- coding: utf-8 -*-
"""
Created on Mon Dec 18 08:49:23 2017

@author: Administrator
"""

###InceptionNet module 有tensorboard版本
import numpy as np
import pandas
...
import tensorflow as tf
log_dir1 = 'D:/temp/tensorflow/project/logs/InceptionV3'
    ...
    with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
      ...
      with tf.variable_scope('Mixed_5b'):#第一个模块组的第一个Inception模块
        with tf.variable_scope('Branch_0'):
          ...
          tf.summary.histogram('Conv2d_0a_1x1',branch_0)
        with tf.variable_scope('Branch_1'):
          branch_1 = slim.conv2d(net, 48, [1, 1], scope='Conv2d_0a_1x1')
          tf.summary.histogram('Conv2d_0a_1x1',branch_1)
          branch_1 = slim.conv2d(branch_1, 64, [5, 5], scope='Conv2d_0b_5x5')
          tf.summary.histogram('Conv2d_0b_5x5',branch_1)
        with tf.variable_scope('Branch_2'):
          branch_2 = slim.conv2d(net, 64, [1, 1], scope='Conv2d_0a_1x1')
          tf.summary.histogram('Conv2d_0a_1x1',branch_2)
          branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0b_3x3')
          tf.summary.histogram('Conv2d_0b_3x3',branch_2)
          branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0c_3x3')
          tf.summary.histogram('Conv2d_0c_3x3',branch_2)
        with tf.variable_scope('Branch_3'):
          branch_3 = slim.avg_pool2d(net, [3, 3], scope='AvgPool_0a_3x3')
          tf.summary.histogram('AvgPool_0a_3x3',branch_3)
          branch_3 = slim.conv2d(branch_3, 32, [1, 1], scope='Conv2d_0b_1x1')
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_5b',net)
      ...
      with tf.variable_scope('Mixed_5c'):#第一个模块组的第二个Inception模块
        ...
        with tf.variable_scope('Branch_1'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_1)
          branch_1 = slim.conv2d(branch_1, 64, [5, 5], scope='Conv_1_0c_5x5')
          tf.summary.histogram('Conv_1_0c_5x5',branch_1)
        with tf.variable_scope('Branch_2'):
          branch_2 = slim.conv2d(net, 64, [1, 1], scope='Conv2d_0a_1x1')
          tf.summary.histogram('Conv2d_0a_1x1',branch_2)
          branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='Conv2d_0b_3x3')
        ...
        with tf.variable_scope('Branch_3'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_5c',net)
      ...
      with tf.variable_scope('Mixed_5d'):#第一个模块组的第三个Inception模块
        ...
        with tf.variable_scope('Branch_3'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_5d',net)
...
#        net = tf.concat([branch_0, branch_1, branch_2], 3)
      ...
      with tf.variable_scope('Mixed_6b'):#第二个模块组的第二个Inception模块
        ...
        with tf.variable_scope('Branch_1'):
          ...
          tf.summary.histogram('Conv2d_0b_1x7',branch_1)
...
#          branch_2 = slim.conv2d(branch_2, 128, [7, 1], scope='Conv2d_0b_7x1')
          ...
          tf.summary.histogram('Conv2d_0c_1x7',branch_2)
#          branch_2 = slim.conv2d(branch_2, 128, [7, 1], scope='Conv2d_0d_7x1')
          branch_2 = slim.conv2d(branch_2, 192, [1, 7], scope='Conv2d_0e_1x7')
          tf.summary.histogram('Conv2d_0e_1x7',branch_2)
        with tf.variable_scope('Branch_3'):
          branch_3 = slim.avg_pool2d(net, [3, 3], scope='AvgPool_0a_3x3')
          tf.summary.histogram('AvgPool_0a_3x3',branch_3)
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_6b',net)
...
#          branch_1 = slim.conv2d(branch_1, 192, [7, 1], scope='Conv2d_0c_7x1')
        with tf.variable_scope('Branch_2'):
          ...
          tf.summary.histogram('Conv2d_0b_7x1',branch_2)
...
#          branch_2 = slim.conv2d(branch_2, 160, [7, 1], scope='Conv2d_0d_7x1')
        ...
        with tf.variable_scope('Branch_3'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_6c',net)
...
#          branch_2 = slim.conv2d(branch_2, 160, [7, 1], scope='Conv2d_0d_7x1')
        ...
        with tf.variable_scope('Branch_3'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_6d',net)
...
#          branch_2 = slim.conv2d(branch_2, 192, [7, 1], scope='Conv2d_0d_7x1')
        ...
        with tf.variable_scope('Branch_3'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_6e',net)
      ...
      with tf.variable_scope('Mixed_7a'):#第三个模块组的第1个Inception模块
        with tf.variable_scope('Branch_0'):
          ...
          tf.summary.histogram('Conv2d_1a_3x3',branch_0)
        with tf.variable_scope('Branch_1'):
          branch_1 = slim.conv2d(net, 192, [1, 1], scope='Conv2d_0a_1x1')
          tf.summary.histogram('Conv2d_0a_1x1',branch_1)
          branch_1 = slim.conv2d(branch_1, 192, [1, 7], scope='Conv2d_0b_1x7')
...
#          branch_1 = slim.conv2d(branch_1, 192, [7, 1], scope='Conv2d_0c_7x1')
          branch_1 = slim.conv2d(branch_1, 192, [1, 3], stride=2,
                                 padding='VALID', scope='Conv2d_1a_3x3')
          tf.summary.histogram('Conv2d_1a_3x3',branch_1)
        with tf.variable_scope('Branch_2'):
          branch_2 = slim.max_pool2d(net, [1, 3], stride=2, padding='VALID',
                                     scope='MaxPool_1a_3x3')
          tf.summary.histogram('MaxPool_1a_3x3',branch_2)
        net = tf.concat([branch_0, branch_1, branch_2], 3)
        tf.summary.histogram('Mixed_7a',net)
      ...
      with tf.variable_scope('Mixed_7b'):#第三个模块组的第2个Inception模块
        ...
        with tf.variable_scope('Branch_1'):
          ...
          tf.summary.histogram('Conv2d_0b_3x1',branch_1)
        with tf.variable_scope('Branch_2'):
          ...
          tf.summary.histogram('Conv2d_0d_3x1',branch_2)
        with tf.variable_scope('Branch_3'):
          branch_3 = slim.avg_pool2d(net, [1, 3], scope='AvgPool_0a_3x3')
          tf.summary.histogram('AvgPool_0a_3x3',branch_3)
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_7b',net)
      ...
      with tf.variable_scope('Mixed_7c'):#第三个模块组的第3个Inception模块
        ...
        with tf.variable_scope('Branch_1'):
          ...
          tf.summary.histogram('Conv2d_0c_3x1',branch_1)
        with tf.variable_scope('Branch_2'):
          branch_2 = slim.conv2d(net, 448, [1, 1], scope='Conv2d_0a_1x1')
          tf.summary.histogram('Conv2d_0a_1x1',branch_2)
          branch_2 = slim.conv2d(
        ...
        with tf.variable_scope('Branch_3'):
          ...
          tf.summary.histogram('Conv2d_0b_1x1',branch_3)
        net = tf.concat([branch_0, branch_1, branch_2, branch_3], 3)
        tf.summary.histogram('Mixed_7c',net)
  ...
  with tf.variable_scope(scope, 'InceptionV3', [inputs, num_classes],
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
        ...
        tf.summary.histogram('aux_logits',aux_logits)
        with tf.variable_scope('AuxLogits'):
          aux_logits = slim.avg_pool2d(
              aux_logits, [1, 5], stride=3, padding='VALID',
              scope='AvgPool_1a_5x5')
          tf.summary.histogram('AvgPool_1a_5x5',aux_logits)
          aux_logits = slim.conv2d(aux_logits, 128, [1, 1],
                                   scope='Conv2d_1b_1x1')
          tf.summary.histogram('Conv2d_1b_1x1',aux_logits)
          ...
          tf.summary.histogram('Conv2d_2a_5x5',aux_logits)
          aux_logits = slim.conv2d(
              aux_logits, num_classes, [1, 1], activation_fn=None,
              normalizer_fn=None, weights_initializer=trunc_normal(0.001),
              scope='Conv2d_2b_1x1')
          tf.summary.histogram('Conv2d_2b_1x1',aux_logits)
#          if spatial_squeeze:
#            aux_logits = tf.squeeze(aux_logits, [1, 2], name='SpatialSqueeze')
      ...
      with tf.variable_scope('Logits'):
        ...
        tf.summary.histogram('AvgPool_1a_8x8',net)
        # 1 x 1 x 2048
        ...
        tf.summary.histogram('Conv2d_1c_1x1',logits)
#        if spatial_squeeze:
...
for i in range(10000):
    ...
    if i % 10 == 0:  # Record summaries and test-set accuracy
        summary,acc = sess1.run([merged,accuracy], feed_dict={x:test,y_:label1_test,is_train:False})
        test_writer.add_summary(summary, i)
        print('Accuracy at step %s: %s' % (i, acc))
    else:  # Record a summary
         summary,_ = sess1.run([summary,train_step], feed_dict={x:train[a:a+10],y_:label1[a:a+10],is_train:True})
