# -*- coding: utf-8 -*-
"""
Created on Wed Nov  1 11:03:08 2017
...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  1 10:29:38 2017
...
train_data = [data_cdma_up1,data_lte1]
train = train_data[0]
...
##############
test_data = [test_cdma_up1,test_lte1]
...
h_pool6 = max_pool_2x2(h_conv6)####到这里就能提高一点

W_conv7 = weight_variable([1,1,156,200])
b_conv7 = bias_variable([200])
h_conv7 = tf.nn.relu(conv2d(h_pool6, W_conv7) + b_conv7)

W_conv8 = weight_variable([1,1,200,256])
...
W_fc1 = weight_variable([1* 3 * 256, 3000])
b_fc1 = bias_variable([3000])
h_pool8_flat = tf.reshape(h_pool8, [-1, 1*256*3])
