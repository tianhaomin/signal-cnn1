# -*- coding: utf-8 -*-
"""
Created on Fri Nov  3 08:42:37 2017

@author: Administrator
"""
#########换成平均池化试试,padding模式设置成valid模式
...
W_conv8 = weight_variable([1,3,200,256])
b_conv8 = bias_variable([256])
h_conv8 = tf.nn.relu(conv2d(h_conv7, W_conv8) + b_conv8)
W_conv9 = weight_variable([1,1,256,300])
b_conv9 = bias_variable([300])
...
h_pool9_flat = tf.reshape(h_pool9, [-1, 1*13*300])
